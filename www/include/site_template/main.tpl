...
<head>
    <meta charset="UTF-8">
    <title>clamscribe | {$page_title}</title>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="include/img/avatar2.png" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="include/img/avatar.png" class="img-circle" alt="user image"/>
                                        </div>
                                        <h4>
                                            Developers
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{$smarty_url}?module=traffic"><i class="fa fa-angle-double-right"></i> Overview</a>
                        </li>
                        <li><a href="{$smarty_url}?module=traffic"><i class="fa fa-angle-double-right"></i> All
                                protocols</a></li>
                        <li><a href="{$smarty_url}?module=traffic&page=tcp"><i class="fa fa-angle-double-right"></i> TCP</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="examples/lockscreen.html"><i class="fa fa-angle-double-right"></i> Lockscreen</a>
                        </li>
